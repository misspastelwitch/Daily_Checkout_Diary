...
**Learning journal 03/12**
Vandaag heb ik een CSS Grid workshop gedaan. het was heel nuttig om een refresh te hebben over grid en ook over micro-layouts te leren. Dit wil ik in mijn site gebruiken om mijn comments sectie te verbeteren.
**Learning journal 04/12**
Vandaag ben ik begonnen met JS te leren. We hebben 3 opdrachten gedaan, 'de console', '3 stappenplan' en 'van comments naar code'. Ik keb al een micro-interactie geimplementeerd in mijn code, namelijk een 'toon meer' button. Ik wil ook mijn hamburger button werkend maken met js om mijn header kleiner te maken op kleiner viewports, maar tot nu werkt het niet.
**Learning journal 09/12**
Vandaag hebben we met js nieuwe UI events gemaakt. Ik heb 7 verschillende events gemaakt waarbij iedere knop een andere animatie doet waneer een andere 'event' op de pagina is. 
**Learning journal 11/12**
Ik heb vandaag over forms en states geleerd. Ik heb een nieuwe toggle state aangepast in  mijn  show more button, en ook een paar changes gemaakt op mijn zoekbalk. Voor vrijdag wil ik dat de kleur van mijn  search gaat terug naar wit na de invalid search. Vrijdag wil ik graag mijn show more button testen.
**Learning journal 16/12**
Vandaag hadden we over icons en navigeren. We hebben verschillende sites gechecked om te zien hoe de navigatie werkt en wat voor icoontjes ze gebruiken, en daarna kreeg we een opdracht om icons te tekenen en laten labelen van andere groepen. Ik merkte dat sommige icons altijd goed gelabelkd waren maar anderen helemaal andere 'betekenissen' hadde. Ik wil graag een paar icoontjes toevoegen aan mijn website om het duidelijker te maken wat alles is zonder te veel worden te gebruiken.
